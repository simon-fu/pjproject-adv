...
void SwigDirector_PjsuaAppCallback::onStarted(char const *msg) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object in PjsuaAppCallback::onStarted ");
  }
...
void SwigDirector_PjsuaAppCallback::onStopped(int restart) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null upcall object in PjsuaAppCallback::onStopped ");
  }
  if (swigjobj) jenv->DeleteLocalRef(swigjobj);
}
